...
export const translations = {
  sr: {
    ...
    hero: {
      ...
      cta: "POŠALJITE DETALJE PROJEKTA",
      emailUs: "EMAIL",
      whatsapp: "WHATSAPP",
    ...
    sections: {
      ...
      ctaModal: {
        title: "POŠALJITE DETALJE PROJEKTA",
        contact: "Kontakt (email ili telefon)",
        contactPlaceholder: "email@example.com ili +381 60 123 4567",
        projectType: "Tip projekta",
        projectTypeOptions: {
          residential: "Stambeni prostor (zid/soba)",
          commercial: "Poslovni prostor",
          facade: "Fasada / eksterijer",
          other: "Drugo",
        },
        size: "Veličina / obim",
        sizePlaceholder: "npr. 2 zida, ~15m² ili cela kancelarija",
        location: "Lokacija",
        locationPlaceholder: "Grad ili region",
        note: "Napomena",
        notePlaceholder: "Opciono - sve dodatne informacije",
        optional: "opciono",
        submit: "POŠALJI",
        submitting: "Šalje se...",
        success: "Poslato! Kontaktiraćemo vas u roku od 8 sati.",
        error: "Greška. Pokušajte ponovo ili kontaktirajte nas direktno.",
        promise: "Odgovaramo u roku od 8 sati. Fotografije i detalje možete poslati naknadno.",
      },
      collaborationProcess: {
        title: "Kako funkcioniše saradnja",
        steps: [
          {
            title: "Vi šaljete informacije o zidu",
            description: "Opišete projekat, mi procenjujemo izvodljivost i dajemo cenu.",
          },
          {
            title: "Mi dolazimo i štampamo",
            description: "Sva oprema dolazi sa nama. Bez građevinskih radova, bez prekida poslovanja.",
          },
          {
            title: "Zid je spreman za upotrebu",
            description: "Trajno, izdržljivo, bez dodatnog održavanja. Gotovo istog dana.",
          },
        ],
      },
    },
  ...
  en: {
    ...
    sections: {
      ...
      ctaModal: {
        ...
        contactPlaceholder: "email@example.com or +1 234 567 8900",
        projectType: "Project type",
        projectTypeOptions: {
          residential: "Residential (wall/room)",
          commercial: "Commercial space",
          facade: "Facade / exterior",
          other: "Other",
        },
        size: "Size / scope",
        sizePlaceholder: "e.g. 2 walls, ~15m² or whole office",
        location: "Location",
        locationPlaceholder: "City or region",
        note: "Note",
        notePlaceholder: "Optional - any additional information",
        optional: "optional",
        submit: "SUBMIT",
        submitting: "Sending...",
        success: "Sent! We'll contact you within 8 hours.",
        error: "Error. Please try again or contact us directly.",
        promise: "We respond within 8 hours. Photos and details can be sent later.",
      },
      collaborationProcess: {
        title: "How collaboration works",
        steps: [
          {
            title: "You send wall information",
            description: "Describe your project, we assess feasibility and provide pricing.",
          },
          {
            title: "We arrive and print",
            description: "All equipment comes with us. No construction work, no business interruption.",
          },
          {
            title: "Wall is ready to use",
            description: "Permanent, durable, no additional maintenance. Done same day.",
          },
        ],
      },
    },
  ...
  ru: {
    ...
    hero: {
      ...
      phone: "+381 60 503 0043",
      microcopy: "Рекомендуется: размеры, тип поверхности, фотографии стены.",
    ...
    sections: {
      ...
      ctaModal: {
        title: "ОТПРАВИТЬ ДЕТАЛИ ПРОЕКТА",
        contact: "Контакт (email или телефон)",
        contactPlaceholder: "email@example.com или +7 123 456 7890",
        projectType: "Тип проекта",
        projectTypeOptions: {
          residential: "Жилое помещение (стена/комната)",
          commercial: "Коммерческое помещение",
          facade: "Фасад / экстерьер",
          other: "Другое",
        },
        size: "Размер / объём",
        sizePlaceholder: "например, 2 стены, ~15м² или весь офис",
        location: "Местоположение",
        locationPlaceholder: "Город или регион",
        note: "Примечание",
        notePlaceholder: "Необязательно - любые дополнительные сведения",
        optional: "необязательно",
        submit: "ОТПРАВИТЬ",
        submitting: "Отправляется...",
        success: "Отправлено! Мы свяжемся с вами в течение 8 часов.",
        error: "Ошибка. Попробуйте снова или свяжитесь с нами напрямую.",
        promise: "Отвечаем в течение 8 часов. Фотографии и детали можно отправить позже.",
      },
      collaborationProcess: {
        title: "Как работает сотрудничество",
        steps: [
          {
            title: "Вы отправляете информацию о стене",
            description: "Опишите проект, мы оцениваем выполнимость и даём цену.",
          },
          {
            title: "Мы приезжаем и печатаем",
            description: "Всё оборудование с нами. Без строительных работ, без простоя бизнеса.",
          },
          {
            title: "Стена готова к использованию",
            description: "Постоянно, надёжно, без дополнительного обслуживания. Готово в тот же день.",
          },
        ],
      },
    },
