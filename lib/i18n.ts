...
export const translations = {
  sr: {
    ...
    hero: {
      ...
      toggleB2C: "Stan / kuća",
      pathSelectionHelper: "Izaberite tip prostora da bismo prikazali relevantne primere i proces.",
      pathChangeLink: "Promeni tip prostora",
    ...
    sections: {
      ...
      ctaReset: {
        headline: "Zatražite procenu vašeg projekta",
        headlineB2B: "Zatražite procenu vašeg poslovnog prostora",
        headlineB2C: "Zatražite procenu za vaš dom",
        helper: "Odgovaramo u roku od 8 sati.",
        helperB2B: "Po potrebi radimo i van radnog vremena.",
        helperB2C: "Bez remonta. Zid je spreman za korišćenje odmah.",
      },
      ctaModal: {
  ...
  en: {
    ...
    hero: {
      ...
      toggleB2C: "Home",
      pathSelectionHelper: "Choose space type to see relevant examples and process.",
      pathChangeLink: "Change space type",
    ...
    sections: {
      ...
      ctaReset: {
        headline: "Request assessment for your project",
        headlineB2B: "Request assessment for your commercial space",
        headlineB2C: "Request assessment for your home",
        helper: "We respond within 8 hours.",
        helperB2B: "We can work outside business hours if needed.",
        helperB2C: "No renovation. Wall is usable immediately.",
      },
      collaborationProcess: {
  ...
  ru: {
    ...
    hero: {
      ...
      toggleB2C: "Дом",
      pathSelectionHelper: "Выберите тип помещения, чтобы увидеть соответствующие примеры и процесс.",
      pathChangeLink: "Изменить тип помещения",
    ...
    sections: {
      ...
      ctaReset: {
        headline: "Запросите оценку вашего проекта",
        headlineB2B: "Запросите оценку вашего коммерческого помещения",
        headlineB2C: "Запросите оценку для вашего дома",
        helper: "Отвечаем в течение 8 часов.",
        helperB2B: "При необходимости работаем и вне рабочего времени.",
        helperB2C: "Без ремонта. Стена готова к использованию сразу.",
      },
      ctaModal: {
