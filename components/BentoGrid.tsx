          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-sm border border-[#ededed]/10 bg-[#0a0c0a] p-8 transition-all duration-300 hover:border-[#ededed]/20 hover:shadow-[0_0_30px_rgba(57,255,20,0.1)] ${
              ...
              >
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative rounded-sm border border-[#ededed]/10 bg-[#0a0c0a] p-4 transition-all duration-300 group-hover:border-[#39FF14]/30">
